...
foreach file {
    ...
    break.tcl block.tcl instrument.tcl gui.tcl guiUtil.tcl widget.tcl
    bindings.tcl icon.tcl selection.tcl tabnotebook.tcl tkcon.tcl
...
#	be executed in the application, and another script
